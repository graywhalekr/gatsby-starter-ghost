...
module.exports = {
    siteUrl:
        process.env.NODE_ENV === `production`
            ? process.env.SITE_URL || config.siteUrl || `https://github.com/graywhalekr/gatsby-starter-ghost`
            : `https://github.com/graywhalekr/gatsby-starter-ghost`, // Site domain. Do not include a trailing slash!
